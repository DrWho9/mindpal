...
mpCompanion={COMPANION_POLICY_VERSION,DEFAULT_PAGES_BASE,BASE_STORAGE_KEY,BASE_WINDOW_KEY,SAFETY_STATES,LIVE_LABEL,DEMO_LABEL,UNAVAILABLE_NOTE,joinCompanionUrl,resolveCompanionBase,companionUrl,parseCompanionStatus,fetchCompanionStatus,parseCompanionReply,buildChatRequest,sendCompanionChat};
...
})();${ytSection}${sidebarShare}${voicePicker}${feelingsUi}${reflectUi}`;
}
