...
— MindPal daily reading`);m(e===`copied`?`Copied.`:`Could not copy.`),setTimeout(()=>m(``),2e3)},children:`Copy`}),(0,A.jsx)(`button`,{className:`secondary`,type:`button`,onClick:()=>f(!d),children:`Choose another morning practice`}),i?(0,A.jsx)(`button`,{className:`secondary`,type:`button`,onClick:()=>{y(),ut(),m(``),c(mpReadings.pickRandom(a,b.id))},children:`Another random reading`}):null]}),d?(0,A.jsxs)(`p`,{className:`muted mindpal-other-practice`,children:[`Verse, videos and other Explore cards stay available. Homemade Pack B is not the daily default until 100/100 Done. Opening, Listen or Copy does not mark a reading Done.`] }):null,p||g?(0,A.jsx)(`p`,{role:`status`,"aria-live":`polite`,children:p||g}):null]})}
